...
interface IMobilePhone extends IPhone {
  size: string
  companyPartner: IPhone['company'] //"same type as company in Phone"; // dinamyc IPhone
  manufactured: Date
}
...
console.log(filterPhonesByDate(phones, 'manufactured', '2022-01-01')) // Телефоны позже даты.
